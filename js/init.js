...
var cradle = function () {
	...
	/*Typed js start*/
	$("#typed").typed({
		strings: ["^2100&nbsp;I am Jordan Haldane.<br/>Graphic/web designer.<br/> Living in Kansas City area."],
		typeSpeed: 30,
		backDelay: 750,
		loop: false,
		cursorChar: "|",
...
//todo: fix so I don't have to have an empty port...
...
$(window).on("resize", function () {
	...
	setHeight();
	// todo: removed for site to work w/o timeline
	// timelineheightCal();
...
$(document).on("ready", function () {
	/*cradle function init start*/
	cradle();
	/*cradle function init end*/
